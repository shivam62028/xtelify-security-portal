...
# Replace the whole ai remediation block
start_str = 'async def _process_ai_remediation'
...
new_str = """async def process_remediation_worker(cache_id: str, upload_batch: str, source_format: str, context_str: str):
    try:
        import httpx
...
print("Replaced backend successfully.")
